...
export const SEMESTER_DATA = {
  'First Year': {
    'Semester 1 (Physics Group)': [
      { name: 'Eng. Physics', credits: 5, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Eng. Mathematics-I', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Elements of Mech & Elec', credits: 5, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Eng. Mechanics', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Comp. Programming', credits: 3, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Yoga & Meditation', credits: 1, intMax: 50, extMax: 0, isTheory: false },
    ],
    'Semester 2 (Chemistry Group)': [
      { name: 'Eng. Chemistry', credits: 5, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Eng. Mathematics-II', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Civil & Elec Eng', credits: 5, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Eng. Graphics', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Elec-Electronic Comp', credits: 3, intMax: 30, extMax: 70, isTheory: true },
  ...
  'Second Year': {
    'Semester 3': [
      ...
      { name: 'Digital Sys & Micro', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Data Structures', credits: 5, intMax: 30, extMax: 70, isTheory: true },
      { name: 'Data Comm & Net', credits: 4, intMax: 30, extMax: 70, isTheory: true },
    ...
    'Semester 4': [
      ...
      { name: 'Adv. Microprocessor', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      ...
      { name: 'Linux/Shell Lab', credits: 2, intMax: 50, extMax: 50, isTheory: false },
  ...
  'Third Year': {
    'Semester 5': [
      ...
      { name: 'Database Eng', credits: 4, intMax: 30, extMax: 70, isTheory: true },
    ...
    'Semester 6': [
      ...
      { name: 'Comp Graphics & MM', credits: 4, intMax: 30, extMax: 70, isTheory: true },
  ...
  'Final Year': {
    'Semester 7': [
      ...
      { name: 'Soft Computing', credits: 4, intMax: 30, extMax: 70, isTheory: true },
      ...
      { name: 'Internship', credits: 3, intMax: 50, extMax: 50, isTheory: false },
    ],
    'Semester 8': [
